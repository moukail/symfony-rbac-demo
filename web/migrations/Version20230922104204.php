 ...
 */
final class Version20230922104204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE permission (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_E04992AAEA750E8 (label), UNIQUE INDEX UNIQ_E04992AA772E836A (identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
